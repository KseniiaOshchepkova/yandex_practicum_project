...
|[project_02](): Исследование надёжности заёмщиков|Изучение как семейное положение и количество детей клиента влияет на факт погашения кредита в срок.|pandas pymystem3|
